...
public class EditRecipeStepThree extends Fragment implements Step, View.OnClickListener {
    ...
    public static EditRecipeStepThree newInstance(String param1, String param2) {
        EditRecipeStepThree fragment = new EditRecipeStepThree();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        instructionLinearLayout = view.findViewById(R.id.edit_recipe_instruction_list);
